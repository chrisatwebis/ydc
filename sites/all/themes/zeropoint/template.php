...
/**Custom theme list**/
function zeropoint_views_mini_pager($tags = array(), $limit = 10, $element = 0, $parameters = array(), $quantity = 9) {
  ...
  if ($pager_total[$element] > 1) {
    ...
    $items[] = array(
      'class' => 'pager-current', 
      'data' => t('<span class="current_page_item">@current</span> of @max', array('@current' => $pager_current, '@max' => $pager_max)),
    );
